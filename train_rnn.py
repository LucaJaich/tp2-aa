...
loss_punt_inic = nn.CrossEntropyLoss()
loss_punt_final = nn.CrossEntropyLoss()
loss_caps = nn.CrossEntropyLoss()
...
val_dataloader = torch.utils.data.DataLoader(test_dataset, batch_size=BATCH_SIZE, shuffle=False, collate_fn=collate_fn)
